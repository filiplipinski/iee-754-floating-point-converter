...
module.exports = {"converter":"converter","converter__container":"converter__container","converter__labeled-input":"converter__labeled-input","converter__buttons-container":"converter__buttons-container","bin":"bin"};
...
// extracted by mini-css-extract-plugin
module.exports = {"fp-converter":"fp-converter","fp-converter__container":"fp-converter__container","fp-converter__labeled-input":"fp-converter__labeled-input","fp-converter__buttons-container":"fp-converter__buttons-container","bin":"bin","fp-converter__iee754-representation":"fp-converter__iee754-representation","results":"results","exponent":"exponent","to-bin":"to-bin","to-dec":"to-dec"};
...
*/
var aa=__webpack_require__(0),n=__webpack_require__(7),r=__webpack_require__(15);function u(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(u(227));
...
// extracted by mini-css-extract-plugin
module.exports = {"btnsBox":"btnsBox"};
...
// EXTERNAL MODULE: ./src/components/Converter/style.module.scss
var style_module = __webpack_require__(10);
...
const Converter_style = bem_css_modules_default()(style_module_default.a);
const Converter = () => {
    const [decValue, setDecValue] = Object(react["useState"])("");
    const [binValue, setBinValue] = Object(react["useState"])("");
    ...
    const decToBinary = (entryDecValue) => {
    ...
    const binaryToDec = (entryValueStr) => {
        let result = 0;
        if (entryValueStr) {
            let j = 0;
    ...
    return (react_default.a.createElement("div", { className: Converter_style() },
        react_default.a.createElement("h1", null, "Converter integer number to binary and vice versa"),
        react_default.a.createElement("div", { className: Converter_style("container") },
            react_default.a.createElement("div", { className: Converter_style("labeled-input") },
                react_default.a.createElement("label", { htmlFor: "dec" }, "Decimal number"),
                react_default.a.createElement("input", { id: "dec", type: "number", min: "0", value: decValue, onChange: inputOnChange })),
            react_default.a.createElement("div", { className: Converter_style("buttons-container") }),
            react_default.a.createElement("div", { className: Converter_style("labeled-input") },
                react_default.a.createElement("label", { htmlFor: "bin" }, "Binary number"),
                react_default.a.createElement("input", { id: "bin", type: "number", value: binValue, onChange: inputOnChange })))));
};
/* harmony default export */ var components_Converter = (Converter);

// EXTERNAL MODULE: ./src/components/FpConverter/style.module.scss
var FpConverter_style_module = __webpack_require__(11);
var FpConverter_style_module_default = /*#__PURE__*/__webpack_require__.n(FpConverter_style_module);

// CONCATENATED MODULE: ./src/utils/convertNumberSystem.ts
const convertNumberSystem_decToBinary = (entryDecValue) => {
...
const convertNumberSystem_binaryToDec = (entryValue) => {
    let result = 0;
    if (entryValue) {
        let j = 0;
...
const decDecimalPartToBin = (entryDecimalNumber) => {
    ...
    while (entry !== 0) {
        entry = entry * 2;
        if (usedDecimals.includes(entry.toString()))
            break;
        if (usedDecimals.length > 1000)
            break;
...
const binDecimalToDec = (entryBin) => {
...
// CONCATENATED MODULE: ./src/components/FpConverter/index.tsx




const FpConverter_style = bem_css_modules_default()(FpConverter_style_module_default.a);
const FpConverter = () => {
    var _a, _b, _c, _d;
    const [decValue, setDecValue] = Object(react["useState"])("");
    const [binValue, setBinValue] = Object(react["useState"])("");
    const [IEEE754representationToBin, setIEEE754ToBin] = Object(react["useState"])({
        sign: undefined,
        exponent: undefined,
        mantissa: undefined,
    });
    const [IEEE754representationToDec, setIEEE754ToDec] = Object(react["useState"])({
        sign: undefined,
        exponent: undefined,
        mantissa: undefined,
    });
    ...
    const decToBinaryFP = (entryDecValue) => {
        const IEEE754 = [];
        const sign = parseFloat(entryDecValue) >= 0 ? "0" : "1";
        IEEE754.push(sign);
        const [wholePortion, decimalPortion] = entryDecValue.split(".");
        const wholeNumberBIN = convertNumberSystem_decToBinary(wholePortion);
        ...
        const exponentBIN = convertNumberSystem_decToBinary(exponentDEC);
    ...
    const binaryToDecFP = (entryValueStr) => {
        const entryValueArr = entryValueStr.split("");
        if (entryValueArr.length < 32) {
            for (let i = 0; i < 32; i++) {
                if (typeof entryValueArr[i] !== "string")
                    entryValueArr[i] = "0";
            }
        }
        ...
        const exponentDEC = convertNumberSystem_binaryToDec(exponent);
    ...
    return (react_default.a.createElement("div", { className: FpConverter_style() },
        react_default.a.createElement("h1", null, "IEEE-754 single precision (32bits)"),
        react_default.a.createElement("div", { className: FpConverter_style("container") },
            react_default.a.createElement("div", { className: FpConverter_style("labeled-input") },
                react_default.a.createElement("label", { htmlFor: "dec" }, "Decimal number"),
                react_default.a.createElement("input", { id: "dec", type: "number", min: "0", value: decValue, onChange: inputOnChange })),
            react_default.a.createElement("div", { className: FpConverter_style("buttons-container") },
                react_default.a.createElement("button", { onClick: () => decToBinaryFP(decValue) }, "to BINARY \u2192"),
                react_default.a.createElement("button", { onClick: () => binaryToDecFP(binValue) }, "\u2190 to DEC")),
            react_default.a.createElement("div", { className: FpConverter_style("labeled-input") },
                react_default.a.createElement("label", { htmlFor: "bin" }, "Binary number"),
                react_default.a.createElement("input", { id: "bin", type: "number", value: binValue, onChange: inputOnChange }))),
        react_default.a.createElement("div", { className: FpConverter_style("iee754-representation") },
            react_default.a.createElement("div", { className: "results to-bin" },
                react_default.a.createElement("p", null,
                    "Sign: ",
                    react_default.a.createElement("span", null, IEEE754representationToBin.sign || "---")),
                react_default.a.createElement("div", null,
                    "Exponent:",
                    react_default.a.createElement("span", null, IEEE754representationToBin.exponent ? (react_default.a.createElement("div", { className: "exponent" },
                        react_default.a.createElement("p", null,
                            "2",
                            react_default.a.createElement("sup", null, IEEE754representationToBin.exponent.powerTo)),
                        react_default.a.createElement("p", null,
                            "DEC: ",
                            IEEE754representationToBin.exponent.dec),
                        react_default.a.createElement("p", null,
                            "BIN: ",
                            IEEE754representationToBin.exponent.bin,
                            " "))) : ("---"))),
                react_default.a.createElement("p", null,
                    "Mantissa: ",
                    react_default.a.createElement("span", null, ((_a = IEEE754representationToBin.mantissa) === null || _a === void 0 ? void 0 : _a.bin) || "---"))),
            react_default.a.createElement("div", { className: "results to-dec" },
                react_default.a.createElement("p", null,
                    "Sign: ",
                    react_default.a.createElement("span", null, IEEE754representationToDec.sign || "---")),
                react_default.a.createElement("div", null,
                    "Exponent:",
                    react_default.a.createElement("span", null, IEEE754representationToDec.exponent ? (react_default.a.createElement("div", { className: "exponent" },
                        react_default.a.createElement("p", null,
                            "2",
                            react_default.a.createElement("sup", null, IEEE754representationToDec.exponent.powerTo)),
                        react_default.a.createElement("p", null,
                            "DEC: ",
                            IEEE754representationToDec.exponent.dec),
                        react_default.a.createElement("p", null,
                            "BIN: ",
                            IEEE754representationToDec.exponent.bin,
                            " "))) : ("---"))),
                react_default.a.createElement("p", null,
                    "Mantissa:",
                    react_default.a.createElement("span", null, ((_b = IEEE754representationToDec.mantissa) === null || _b === void 0 ? void 0 : _b.bin) ? `${(_c = IEEE754representationToDec.mantissa) === null || _c === void 0 ? void 0 : _c.bin} (in DEC: ${(_d = IEEE754representationToDec.mantissa) === null || _d === void 0 ? void 0 : _d.dec})`
                        : "---"))))));
};
/* harmony default export */ var components_FpConverter = (FpConverter);
...
bem_css_modules_default.a.setSettings({
    modifierDelimiter: "--",
    throwOnError: true,
});
const App_App = () => {
    const [integersOrReal, setIntegersOrReal] = Object(react["useState"])("real");
    return (react_default.a.createElement("div", { className: "app" },
        react_default.a.createElement(react_router_dom_BrowserRouter, null,
            react_default.a.createElement("div", { className: "btnsBox" },
                react_default.a.createElement("button", { className: "chooseType", onClick: () => setIntegersOrReal("real") }, "Real number"),
                react_default.a.createElement("button", { className: "chooseType", onClick: () => setIntegersOrReal("integers") }, "Integers number")),
            integersOrReal === "integers" && react_default.a.createElement(components_Converter, null),
            integersOrReal === "real" && react_default.a.createElement(components_FpConverter, null),
            react_default.a.createElement("footer", null, "Author: Filip Lipi\u0144ski"))));
};

// CONCATENATED MODULE: ./src/AppLoader.tsx



const AppLoader_render = (element) => {
    react_dom_default.a.render(react_default.a.createElement(App_App, null), element);
};

// CONCATENATED MODULE: ./src/index.ts

const src_element = document.getElementById('root-element');
if (src_element) {
    AppLoader_render(src_element);
}
